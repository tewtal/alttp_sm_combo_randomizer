...
class Randomizer {
	...
	static protected $logic_array = [
		0x22, 0xCD, 0xB6, 0xA5, 0xEC, 0xF8, 0xC1, 0x80,0x8B, 0x53, 0x88, 0xA8, 0xB9, 0x22, 0xD9, 0x29,
		0xC4, 0x52, 0xBC, 0xD7, 0xC2, 0xE0, 0x43, 0x2B,0x0D, 0x9F, 0x66, 0x7A, 0x98, 0xDA, 0xBC, 0x05,
		0xB2, 0xF0, 0xA9, 0xFE, 0x27, 0x4A, 0x31, 0x9E,0xFD, 0x3F, 0xEA, 0x72, 0x2E, 0x39, 0xF3, 0x94,
		0x7C, 0x44, 0xA3, 0x60, 0x42, 0x5C, 0x84, 0x50,0xCE, 0x38, 0x6C, 0x03, 0xDF, 0xC9, 0x58, 0xD5,
		0x7F, 0x55, 0x54, 0x34, 0x12, 0x0E, 0x59, 0xA1,0x7B, 0xCC, 0x3C, 0xAE, 0x90, 0x01, 0xAA, 0xA4,
		...
		0xBE, 0x73, 0x51, 0x35, 0xE1, 0x8A, 0xBB, 0x36,0x0C, 0x95, 0xC8, 0x25, 0xCF, 0x1C, 0xA0, 0xB3,
		0x7D, 0x78, 0x4F, 0x18, 0x91, 0x56, 0xA2, 0xCA,0xEB, 0xE8, 0x93, 0xC0, 0xDB, 0x81, 0x62, 0xED,
		0xE1, 0x6B, 0x63, 0x2A, 0xF9, 0x8E, 0xDE, 0xB8,0x26, 0x1F, 0xC3, 0xEF, 0x4B, 0x6F, 0x48, 0x85,
		0xAF, 0xC5, 0x41, 0x2F, 0x5E, 0xD2, 0x9C, 0xD4,0x3E, 0xC6, 0xE5, 0x1A, 0x5B, 0x3B, 0xE4, 0xBA,
	];
	...
	public function __construct($difficulty = 'normal', $logic = 'NoMajorGlitches', $goal = 'ganon', $variation = 'none', $sm_logic = 'Tournament') {
		...
		$this->goal = $goal;
		$this->world = new World($difficulty, $logic, $goal, $variation, $sm_logic);
		$this->seed = new Seed;
